...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_bushy_TH0_MINUS_0016_results1.txt
...
echo "Number attempted in total (Duper-): $totalMinus, number solved in total: $solvedMinus" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_bushy_TH0_MINUS_0016_summary_results.txt
...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_bushy_TH0_MINUS_0016_results2.txt
...
echo "Number attempted in total (Duper+): $totalPlus, number solved in total: $solvedPlus" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_bushy_TH0_MINUS_0016_summary_results.txt
