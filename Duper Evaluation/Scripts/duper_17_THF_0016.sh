...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_THF_0016_results1.txt
		total=$((total+1))
...
echo "Number attempted in total (Duper-): $total, number solved in total: $solved" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_THF_0016_summary_results1.txt
