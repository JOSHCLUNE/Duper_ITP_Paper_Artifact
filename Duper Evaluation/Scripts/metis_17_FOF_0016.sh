...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/metis_17_FOF_0016_results.txt
		total=$((total+1))
...
echo "Number attempted in total: $total, number solved in total: $solved" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/metis_17_FOF_0016_summary_results.txt
