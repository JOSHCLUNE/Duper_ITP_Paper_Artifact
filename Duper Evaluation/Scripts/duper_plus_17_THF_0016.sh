...
# To be run in /Users/jclune/Desktop/17 Provers max_facts_probs/THF_0016
...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_THF_0016_results2.txt
		total=$((total+1))
...
echo "Number attempted in total (Duper+): $total, number solved in total: $solved" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_THF_0016_summary_results2.txt
