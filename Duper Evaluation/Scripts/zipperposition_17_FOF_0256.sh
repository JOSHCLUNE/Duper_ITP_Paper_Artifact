...
do
	...
	then
		...
		echo $res
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/zipperposition_17_FOF_0256_results.txt
		total=$((total+1))
...
echo "Number attempted in total: $total, number solved in total: $solved" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/zipperposition_17_FOF_0256_summary_results.txt
