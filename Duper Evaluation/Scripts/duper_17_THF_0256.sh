...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_THF_0256_results1.txt
		total=$((total+1))
...
echo "Number attempted in total (Duper-): $total, number solved in total: $solved" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_THF_0256_summary_results1.txt
