...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_TH0_MINUS_0016_results1.txt
...
echo "Number attempted in total (Duper-): $totalDuperMinus, number solved in total: $solvedDuperMinus" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_TH0_MINUS_0016_summary_results.txt
...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_TH0_MINUS_0016_results2.txt
...
echo "Number attempted in total (Duper+): $totalDuperPlus, number solved in total: $solvedDuperPlus" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_TH0_MINUS_0016_summary_results.txt
