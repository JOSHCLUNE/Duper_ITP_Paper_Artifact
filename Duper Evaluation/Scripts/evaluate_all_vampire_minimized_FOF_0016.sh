...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_FOF_0016_results1.txt
...
echo "Number attempted in total (Duper-): $totalDuperMinus, number solved in total: $solvedDuperMinus" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_FOF_0016_summary_results.txt
...
do
	...
	then
		...
		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_FOF_0016_results2.txt
...
echo "Number attempted in total (Duper+): $totalDuperPlus, number solved in total: $solvedDuperPlus" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/duper_17_vampire_bushy_FOF_0016_summary_results.txt
...
do
	...
	then
		...
		res=$((timeout 30s /Users/jclune/Desktop/metis/bin/mlton/metis --time-limit 30 $bushyfile) || echo "Metis timed out on $bushyfile") 
 		echo $res >> /Users/jclune/Desktop/Duper\ Evaluation/Results/metis_17_vampire_bushy_FOF_0016_results.txt
...
echo "Number attempted in total (Metis): $totalMetis, number solved in total: $solvedMetis" >> /Users/jclune/Desktop/Duper\ Evaluation/Results/metis_17_vampire_bushy_FOF_0016_summary_results.txt
